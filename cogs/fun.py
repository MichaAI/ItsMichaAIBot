...
class Fun(commands.Cog):
    ...
    async def mood(self, ctx):
        phrases = ["Опять эта банда творит шизу...",
                ...
                "Что во мне такого особенного?... Я просто... испортился со временем :blossombud_ugh: Проблем от меня уже больше, чем пользы... Порчу всем настроение своим присутствием..",
