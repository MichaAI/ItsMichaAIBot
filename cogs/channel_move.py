...
class ChannelMove(commands.Cog):
    ...
    @commands.slash_command(name="переместить_канал", 
                            description="Перемещает канал вверх"
                            "(вниз при отрицательных числах)")
    async def move_channel(self, ctx, channel: typing.Union[
        ...
        await ctx.respond(f'Позиция канала {channel.mention}'
